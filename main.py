...
class GameView(arcade.Window):
    ...
    def setup_widgets(self):
        ...
        self.manager.enable()
        self.anchor_layout = UIAnchorLayout(x=-310, y=-185)
        ...
        self.label = UILabel(text=" ", font_size=14, width=600, height=30, align="left", text_color=(62, 70, 121, 255))
        restart_button = UIFlatButton(text="Сбросить", width=600, height=30)
